...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
            <div class="breadcrumb-title pr-3">Create announcement</div>
            <div class="pl-3">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label>Title</label>
                                        <textarea id="livetext"  name="livetext" class="form-control" rows="10"></textarea>
                                        @error('livetext')
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea id="editor1"  name="announcement" class="form-control" rows="10"></textarea>
                                        @error('announcement')
                                        <span style="color: red;">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control" aria-label="Default select example" name="type">
                                            ...
                                            <option value="0">Poup</option>
                                            <option value="1">None Poup</option>
                                        </select>
                                        @error('type')
                                        <span style="color: red;">
                                                <strong>{{ $message }}</strong>
