    ...
    <div class="row align-items-center">
        <div class="col-md-8">
            <h1 class="display-5 fw-bold mb-2">
                ...
                Add New Profit Withdrawal
            </h1>
            <p class="lead mb-0">Create a new profit withdrawal entry</p>
        </div>
    ...
    <div class="col-lg-8">
        <div class="card gradient-card">
            <div class="card-body p-5">
                ...
                <form action="{{ route('admin.profit-withdrawal.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <button type="submit" class="btn btn-success btn-modern me-3">
