...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
            <div class="breadcrumb-title pr-3">Cron View</div>
            <div class="pl-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="{{url('admin/cron')}}"><i class='bx bx-home-alt'></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Cron View</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-12 col-lg-9 mx-auto">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Create View</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{route('admin.cron.update', $cron->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="form-body">
