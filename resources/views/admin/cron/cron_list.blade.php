    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
                <div class="breadcrumb-title pr-3">Crons</div>
                <div class="pl-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="{{ url('admin/cron') }}"><i
                                        class='bx bx-home-alt'></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Crons</li>
                        </ol>
                    </nav>
                </div>
                <div class="ml-auto">
            ...
            @endif
            <div class="card">
                <div class="card-header">All crons</div>

                <div class="card-body">
                    <form  action="{{ url('admin/cron') }}" method="get">
                        @csrf
                            ...
                            <tbody>
                                ...
                                @foreach ($cronhits as $cronhit)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.cron.edit', $cronhit->id) }}"
                                                class="btn-sm btn-success">View</a>
                                            <a href="{{ url('admin/cron/delete', $cronhit->id) }}"
