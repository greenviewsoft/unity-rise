...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
            <div class="breadcrumb-title pr-3">Create Deposite</div>
            <div class="pl-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="{{url('admin/deposite')}}"><i class='bx bx-home-alt'></i></a>
                        </li>
            ...
            <div class="col-12 col-lg-9 mx-auto">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Details Deposite</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ url('admin/deposite/store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                <div class="form-row">
