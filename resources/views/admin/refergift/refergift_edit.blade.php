            ...
            <div class="col-12 col-lg-9 mx-auto">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Update gift</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{route('admin.refergift.update', $refergift->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="form-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        value="{{ $refergift->recharge }}" placeholder="" />
                                        @error('recharge')
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        value="{{ $refergift->b_receive }}" placeholder="" />
                                        @error('b_receive')
                                        <span style="color: red;">
                                                <strong>{{ $message }}</strong>
                                            </span>
