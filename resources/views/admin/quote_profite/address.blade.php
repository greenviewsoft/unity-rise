    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
                <div class="breadcrumb-title pr-3">Address</div>
                <div class="pl-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="{{ url('admin/address') }}"><i
                        ...
                        <table class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($addresses as $address)
                                    <tr>
                                        <td>{{ $address->address_base58 }}</td>
                                        <td>{{ $address->private_key }}</td>
                                        <td>{{ isset($address->created_at) ? $address->created_at->diffForHumans() : '' }}</td>
                                        <td>
                                            <a href="{{ url('admin/address/details', $address->id) }}"
