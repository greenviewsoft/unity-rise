...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
            <div class="breadcrumb-title pr-3">Quote create</div>
            <div class="pl-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="{{url('admin/quote_profite')}}"><i class='bx bx-home-alt'></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Quote create</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-12 col-lg-9 mx-auto">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Quote create</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{url('admin/quote/store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="trx_percent" class="form-control" value="{{old('trx_percent')}}"/>
                                        @error('trx_percent')
                                        <span style="color: red;">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="down_up" class="form-control" value="{{old('down_up')}}"/>
                                        @error('down_up')
                                        <span style="color: red;">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control" aria-label="Default select example" name="type">
                                            ...
                                            <option value="Up" {{ old('type') == 'Up' ? 'selected' : '' }}>Up</option>
                                            <option value="down" {{ old('type') == 'down' ? 'selected' : '' }}>down</option>
