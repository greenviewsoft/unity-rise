            ...
            <div class="col-12 col-lg-9 mx-auto">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Create new energy</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{route('admin.energy.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        value="{{ old('energy_amount') }}" placeholder="Energy amount" />
                                        @error('energy_amount')
                                        <span style="color: red;">
                                                <strong>{{ $message }}</strong>
                                            </span>
