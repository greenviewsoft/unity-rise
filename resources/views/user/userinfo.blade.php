...
<div class="page-content footer-clear">
    ...
    <div class="user_info card card-style overflow-visible mt-5">
       <div class="mt-n5"></div>
       <img src="{{ asset('public/assets/user/images/') }}/logo.png" alt="img" width="180" class="mx-auto mt-n5">
       ...
       <div class="content mt-0 mb-2">
          <div class="custom_list_nbr list-group list-custom list-group-flush list-group-m rounded-xs">
             ...
             {{-- <a href="{{ url('user/wallet-guide') }}" class="list-group-item">
                <i class="bi bi-credit-card"></i>
                <div>{{ __('lang.change_withdrawpass') }}</div>
                <i class="bi bi-chevron-right"></i>
             </a> --}}
          </div>
       </div>
